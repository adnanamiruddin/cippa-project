...
const Navbar = () => {
  ...
  return (
    <nav className="flex justify-betweens items-center fixed w-full backdrop-blur-sm z-50 px-4 py-5 md:py-4 md:px-12">
      ...
      <div className="flex w-full justify-end items-center gap-4 text-sm font-semibold md:gap-2">
        <Link
          href="/"
          className="bg-transparent font-bold text-white hover:bg-[#D2FF3A] hover:text-black hover:border-[1px] hover:rounded-md md:px-4"
        >
          Home
        </Link>
        <Link
        ...
        <button
          ...
          className="flex justify-center items-center gap-1 bg-transparent font-bold text-white hover:bg-[#D2FF3A] hover:text-black hover:border-[1px] hover:rounded-md md:px-4"
        >
